...
export const workflowSteps = [
  {
    ...
    text: "My Job Atlas keeps a shared job and company index across Indian job boards, startup listings, internships, and manually submitted URLs. Each role is parsed into skills, seniority, location, salary, source, and freshness signals.",
  },
  {
    icon: Radar,
    title: "Score fit honestly",
    text: "Matching is not just resume-to-job similarity. My Job Atlas combines proven skills, seniority fit, company quality, location, compensation, posting freshness, and candidate strength into an explainable match score.",
  },
  {
    icon: FileText,
